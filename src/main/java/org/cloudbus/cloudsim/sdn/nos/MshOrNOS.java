...
/**
 * MSH-OR: Multi-criteria SFC-aware Optimal Resource scaling (Vertical only).
 *
...
public class MshOrNOS extends NetworkOperatingSystemSimple {
    ...
    public void startEntity() {
        ...
        System.out.println("### MshOrNOS.startEntity() - MSH-OR active | Vertical Scale only");
    }
    ...
    private void runMshOrLogic() {
        ...
        System.out.printf("%.2f: [MSH-OR] %d VNF(s) can scale:%n",
     ...
     *
     * Thuat toan scale VNF co nhieu SFC priority cao truoc (MSH-OR)
